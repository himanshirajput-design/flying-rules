                ...
                <div class="col-md-4">
                    ...
                    <div class="card bg-light border-0">
                        <div class="card-body">
                            ...
                            @if($post->image)
                                <div class="mb-3">
                                    <img src="{{ asset($post->image) }}" class="img-fluid rounded border mb-2" alt="Current Image">
                                    <small class="text-muted d-block">Current image</small>
                                </div>
                            @endif
                            <div class="mb-3">
                                <label class="form-label small">Upload new image (leaves current intact if blank)</label>
