...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h2>Edit Policy Type: {{ $policyType->name }}</h2>
...
<div class="card shadow-sm border-0"><div class="card-body p-4">
    <form action="{{ route('admin.policy-types.update', $policyType) }}" method="POST">
        @csrf
        @method('PUT')
        @include('admin.policy-types.form')
        <button class="btn btn-primary"><i class="fas fa-save me-2"></i>Update Policy Type</button>
    </form>
</div></div>
@endsection
