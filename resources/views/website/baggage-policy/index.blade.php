...
<section class="hero position-relative d-flex align-items-center" style="min-height: 40vh; background: url('{{ asset('images/new_hero_banner_1783530882696.png') }}') no-repeat center center/cover;">
    ...
    <div class="container position-relative text-white" data-aos="fade-up">
        <div class="col-lg-8">
            <h1 class="display-4 fw-bold mb-3">Baggage Policies</h1>
            <div class="breadcrumb text-light fs-5 opacity-75">
                <a href="/" class="text-white text-decoration-none hover-cyan">FlightRules</a> &nbsp;&gt;&nbsp; <span>Baggage Policies</span>
            </div>
        </div>
    </div>
</section>
...
<section class="py-5 bg-light">
    <div class="container">
        <div class="text-center mb-5" data-aos="fade-up">
            ...
            <p class="text-muted">Find specific Baggage Policy rules, fees, and procedures for your airline.</p>
        </div>
