...
<section class="hero position-relative d-flex align-items-center" style="min-height: 40vh; background: url('{{ asset('images/new_hero_banner_1783530882696.png') }}') no-repeat center center/cover;">
    ...
    <div class="container position-relative text-white" data-aos="fade-up">
        <div class="col-lg-8">
            <h1 class="display-4 fw-bold mb-3">All Airlines</h1>
            <div class="breadcrumb text-light fs-5 opacity-75">
                <a href="/" class="text-white text-decoration-none hover-cyan">FlightRules</a> &nbsp;&gt;&nbsp; <span>Airlines</span>
            </div>
        </div>
    </div>
</section>
...
<section class="py-5 bg-light">
    <div class="container">
        <div class="text-center mb-5" data-aos="fade-up">
            <h2 class="display-6 fw-bold text-dark-blue">Explore Our Airlines</h2>
            <p class="text-muted">Select an airline below to view their specific policies and details.</p>
        </div>
                ...
                <a href="{{ $airline['link'] }}" class="text-decoration-none">
                    <div class="card premium-card h-100 border-0 shadow-sm rounded-4 overflow-hidden">
                        <div class="card-img-top-wrap" style="height: 220px; overflow: hidden;">
                            <img src="{{ $airline['image'] ?? 'https://via.placeholder.com/800x400?text=No+Image' }}" class="w-100 h-100 object-fit-cover transition-scale" alt="{{ $airline['name'] }}">
                        </div>
