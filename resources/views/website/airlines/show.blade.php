...
@section('content')
    ...
    <section class="hero position-relative d-flex align-items-center"
        style="min-height: 50vh; background: url('{{ asset('images/cancellation_hero_1783541787247.png') }}') no-repeat center center/cover;">
        ...
        <div class="container py-4">
            <div class="row g-4">
                ...
                <div class="col-md-8" data-aos="fade-up">
                    ...
                    <!-- Author Profile -->
                    <div
                        class="author-profile d-flex flex-column flex-md-row align-items-center align-items-md-start bg-white border p-4 rounded-4 shadow-sm mb-5">
                        <div class="flex-shrink-0 mb-3 mb-md-0 me-md-4">
                            <img src="https://ui-avatars.com/api/?name=Emma+Watson&background=0ea5e9&color=fff&size=120&rounded=true"
                                alt="Emma Watson" class="rounded-circle shadow-sm"
                        ...
                        <div class="flex-grow-1 text-center text-md-start">
                            ...
                            <p class="text-muted small mb-0 lh-lg">Emma is a seasoned travel blogger and policy expert with
                                over 10 years of experience navigating the complexities of airline rules. She helps
                                travelers save money and avoid headaches.</p>
                        </div>
                    </div>
                        ...
                        <a href="{{ $related['link'] }}" class="text-decoration-none">
                            <div class="card premium-card h-100 border-0 shadow-sm rounded-4 overflow-hidden bg-white">
                                ...
                                <div class="card-body p-4">
                                    ...
                                    <p class="small text-muted mb-0">Learn more about the specific terms and conditions for
                                        this airline.</p>
                                </div>
                            </div>
                        </a>
