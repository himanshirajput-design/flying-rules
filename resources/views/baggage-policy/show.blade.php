    ...
    <div class="container position-relative text-white" data-aos="fade-up">
        <div class="col-lg-8">
            ...
            <div class="breadcrumb text-light fs-5 opacity-75">
                ...
                <a href="{{ route('baggage-policy.index') }}" class="text-white text-decoration-none hover-cyan">Baggage Policy</a> &nbsp;&gt;&nbsp; 
                ...
                <div class="card border-0 shadow-sm rounded-4 sticky-top" style="top: 100px;">
                    ...
                    <div class="card-body p-4 bg-light rounded-bottom-4">
                        <ul class="list-unstyled mb-0 toc-list">
                            <li class="mb-3"><a href="#" class="text-decoration-none text-muted hover-cyan"><i class="fas fa-angle-right me-2 small"></i> Baggage Policy Policy</a></li>
...
<section class="py-5 bg-light">
    <div class="container pb-4">
        <h3 class="fw-bold text-dark-blue mb-5">Related Post Baggage Policy</h3>
        <div class="row g-4">
